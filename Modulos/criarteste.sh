...
tput setaf 7 ; tput setab 4 ; tput bold ; printf '%30s%s%-15s\n' "สร้างบัญชีผู้ใช้ทดสอบ" ; tput sgr0
echo ""
...
echo -ne "\033[1;32mรหัส\033[1;37m: "; read pass
if [[ -z $pass ]]
then
echo ""
